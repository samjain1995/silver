        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('admin.dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ getSiteSettings()->company_favicon }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ getSiteSettings()->company_logo }}" alt="" height="60">
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <span class="d-none d-xl-inline-block ml-1">{{Auth::user()->first_name}}  {{Auth::user()->first_name}}</span>
