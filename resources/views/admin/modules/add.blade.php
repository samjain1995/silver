                ...
                <div class="col-xl-12">
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="image" name="image" ng-model="form_filds.image"  ng-files="getTheFiles($files,'form_filds','image')"  accept="image/png, image/gif, image/jpeg" />
