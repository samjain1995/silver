        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <div>
                            <button class="btn btn-success mb-2" ng-click="addRole()">
                                <i class="mdi mdi-plus mr-2"></i> Add Role
                            </button>
                        </div>
                        ...
                        <div class="mb-2 text-right">
                            {{ $roles->appends(app('request')->input())->links() }}
                        </div>
                    </div>
                </div>
                <!-- end card -->
    ...
    <script type="text/javascript">
        app.controller('PageController', function($window, $scope, $location, $http, ngDialog, toaster) {
            $scope.addRole = function() {
                ngDialog.open({
                    template: '{{ route('admin.roles.create') }}',
                    scope: $scope,
                    overlay: true,
                    closeByEscape: true,
